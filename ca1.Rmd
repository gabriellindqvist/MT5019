...
if (chi_squared_result$p.value < 0.05) {
  cat("Conclusion: Reject the null hypothesis.", "\n", "There is a significant association between gender and opinion on legal abortion.")
} else {
  cat("Conclusion: Fail to reject the null hypothesis.", "\n", "There is no significant association between gender and opinion on legal abortion.")
}
